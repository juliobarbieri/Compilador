...
VARIAVEIS	: TIPO TK_ID
			{
				...
				$$.tipo = $1.tipo;	
				empilhaVariavel(label, $1.traducao, label, "");
			}
			...
			TIPO TK_ID TK_ABRE_CLCH E TK_FECHA_CLCH
			{
                ...
                if(str1.compare("string") == 0)
                {
            		...
            		if ($1.traducao == "boolean") {
	              	...
	              	$$.traducao = $4.traducao + "\t" + $1.traducao + " " + tabVariaveis[$2.label].nome + "[" + $4.label + "];\n";            	
            	}
			}
			|
			TIPO TK_ID TK_ABRE_CLCH E TK_FECHA_CLCH TK_ABRE_CLCH E TK_FECHA_CLCH
			{
                ...
                if(str1.compare("string") == 0)
                {
            		...
            		if ($1.traducao == "boolean") {
	              	...
	              	$$.traducao = $4.traducao + $7.traducao + "\t" + $1.traducao + " " + tabVariaveis[$2.label].nome + "[" + $4.label + " * " + $7.label + " + " + $7.label + "];\n";            	
            	}
			}
            ;
...
ATT			: TIPO TK_ID '=' E
			{
                ...
                {
                	if ($2.tipo == $4.tipo) {
                		$$.traducao = $4.traducao + "\t" + "strcpy(" + tabVariaveis[$2.label].nome + ", " + $4.label + ");\n";
                	}
                	else {
					...
					if ((tabVariaveis[$2.label].tipo == $4.tipo) || ($4.tipo == "int" || tabVariaveis[$2.label].tipo == "float")) {
		            	$$.traducao = $4.traducao + "\t" + tabVariaveis[$2.label].nome + " = " + $4.label + ";\n";
                	}
                	// Soma entre chars
                ...
                empilhaVariavel(var.nome, $1.traducao, var.nome, $4.valor);
			}
			;
...
CHAMADA_FNC	: TK_ID TK_ABRE_PAR VAR_FNC TK_FECHA_PAR
			{
				...
				$$.tipo = $1.tipo;
				$$.label = geraLabel();
				empilhaVariavel($$.label, $1.tipo, $$.label, "");	
